...
\end{itemize}
\LoesungKaroTikz{
    \node[box, rounded corners=1pt, text width=2cm] (gq2) {Umsatz Golf Q2};
    \node[box, rounded corners=1pt, text width=2.1cm, right=0.3cm of gq2] (tq2) {Umsatz Tennis Q2};
    \node[box, rounded corners=1pt, text width=2.1cm, right=0.3cm of tq2] (sq2) {Umsatz Safari Q2};

    \node[oval, text width=2.2cm, below=1cm of tq2] (summe) {SUMME (nicht + ! )};
    
    \node[box, rounded corners=1pt, below=1cm of summe] (final) {Gesamtumsatz Q2};
    ...
    %
    %
    \node[box, rounded corners=1pt, text width=2.1cm, right=1cm of sq2] (golf) {Umsatz Golf Q2};
    \node[box, rounded corners=1pt, text width=2.1cm, right=0.3cm of golf] (fakt) {Wachstums-faktor};

    \node[oval, text width=2.2cm, below=1cm of $(golf)!0.5!(fakt)$] (stern) {PRODUKT oder *};
    
    \node[box, rounded corners=1pt, below=1cm of stern] (gq3) {Umsatz Golf Q3};
